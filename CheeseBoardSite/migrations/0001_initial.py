    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timeDate', models.DateTimeField(default=datetime.datetime(2024, 3, 21, 19, 55, 27, 108564, tzinfo=utc))),
        ...
        migrations.CreateModel(
            name='Account',
            fields=[
                ('dateOfBirth', models.DateField(default=datetime.datetime(2024, 3, 21, 19, 55, 27, 106564))),
                ('accountCreationDate', models.DateTimeField(default=datetime.datetime(2024, 3, 21, 19, 55, 27, 106564, tzinfo=utc))),
                ('dateLastLoggedIn', models.DateTimeField(default=datetime.datetime(2024, 3, 21, 19, 55, 27, 106564, tzinfo=utc))),
                ('profilePic', models.ImageField(default='profile_images/default.jpg', upload_to='profile_images')),
                ...
                ('faveCheese', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.SET_NULL, to='CheeseBoardSite.Cheese')),
                ('followers', models.ManyToManyField(blank=True, null=True, related_name='following2', to=settings.AUTH_USER_MODEL)),
                ('following', models.ManyToManyField(blank=True, null=True, related_name='followers2', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timeDate', models.DateTimeField(default=datetime.datetime(2024, 3, 21, 19, 55, 27, 109564, tzinfo=utc))),
